...
psi00 = (1/np.sqrt(2))*np.array([1,1,0])

project4 = MCWF(Omega1=1.01,Omega2=3.01,Delta=0.0,delta=0.0,Gamma1=0.61,Gamma2=0.56,tmax=5.9,init_state=psi00,Nsamples=100)
